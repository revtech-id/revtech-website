/**
 * Default content for revtech-engine.md.
 * Sourced from .agents/rules/revtech-engine.md — the canonical SOP.
 * Users can override this via Settings → Dokumen SOP.
 */
export const REVTECH_ENGINE_DEFAULT = `# RevTech Engine
