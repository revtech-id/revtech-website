...
export default function LayananHeader() {
  return (
    <motion.div initial="hidden" animate="visible" variants={fadeUpVariant} className="text-center mb-16 lg:mb-24 max-w-3xl mx-auto">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-6 tracking-tight leading-[1.1]">
        ...
        <span className="block sm:inline text-blue-600">Digital Anda.</span>
      </h1>
      <p className="text-sm sm:text-base md:text-xl text-gray-600 leading-relaxed font-medium">
