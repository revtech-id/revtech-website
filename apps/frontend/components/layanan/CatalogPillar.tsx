...
export default function CatalogPillar() {
  return (
    <motion.div 
      ...
      className="bg-white border border-gray-100 rounded-[2rem] p-6 sm:p-8 md:p-10 lg:p-14 shadow-sm hover:shadow-xl [transition-property:box-shadow] duration-300 flex flex-col md:flex-row-reverse gap-8 lg:gap-12 items-center relative overflow-hidden group"
    >
      ...
      <div className="flex-1 relative z-10 lg:pl-10">
        ...
        <Button asChild size="lg" className="w-full sm:w-auto bg-blue-900 hover:bg-blue-950 text-[13px] sm:text-sm md:text-base">
          <Link href="/katalog">
