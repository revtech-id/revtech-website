      ...
      >
        ...
        <div className="w-full md:w-[60%] p-8 pt-12 md:py-12 pl-8 md:pl-10 lg:pl-24 flex flex-col justify-center items-start relative z-20">
          ...
          <button
            ...
            className="w-full sm:w-auto bg-white text-blue-950 hover:bg-blue-50 font-black text-sm lg:text-base px-6 py-4 lg:px-8 lg:py-5 rounded-xl hover-btn inline-flex items-center justify-center gap-2"
          >
